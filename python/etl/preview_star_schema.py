...
def preview_fact_table(dataframes):
    ...
    if fact.empty:
        print("\nfact_patient_visits did not load. Check the table exists in uganda_health_db.")
        return
